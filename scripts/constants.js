...
export const SYSTEM_MESSAGES = {
    FETCH_QUESTIONS_ERROR: 'Fragen konnten nicht geladen werden. Bitte versuchen Sie es später erneut.',
    FETCH_COMMENTS_ERROR: 'Kommentare konnten nicht geladen werden. Das Spiel wird ohne Kommentare fortgesetzt.',
